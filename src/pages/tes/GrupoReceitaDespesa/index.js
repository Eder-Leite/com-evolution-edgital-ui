...
import { SchemaGrupoReceitaDespesa, empresa } from '../TesModel';
const url = 'gruposReceitaDespesa';
...
function GrupoReceitaDespesa() {
    ...
    const [grupo, setGrupo] = useState(new SchemaGrupoReceitaDespesa());

    useEffect(() => {
        document.title = 'Evolution Sistemas - eDigital | Grupo de Receita/Despesa';
    }, []);
    ...
    async function buscarCarteiras() {
        await Api({
            method: 'get',
            url: `carteirasFinanceira?resumo`,
            params: {
                empresa,
                page: 0,
                size: 999999999
    ...
    async function salvar() {
        ...
        if (grupo.id > 0) {
            await Api({
                ...
                cancelar();
                pesquisar();
                Toasty.success('Sucesso!', 'Grupo de Receita/Despesa editada com sucesso!');
            })
                .catch(error => {
                    Loading.onHide();
                    console.log(error);
            ...
            await Api({
                ...
                cancelar();
                pesquisar();
                Toasty.success('Sucesso!', 'Grupo de Receita/Despesa adicionada com sucesso!');
            })
                .catch(error => {
                    Loading.onHide();
                    console.log(error);
    ...
    function validaFormulario() {
        try {
            if (grupo.carteira?.id &&
                grupo.descricao.length >= 3) {
                return true;
            } else {
                return false;
            }
    ...
    function inserir() {
        setActiveIndex(1);
        setGrupo(new SchemaGrupoReceitaDespesa());
    }
    ...
    const header = <div className='p-clearfix' style={{ lineHeight: '1.87em' }}>Lista de Grupos de Receita/Despesa</div>;
                            ...
                            <TabPanel disabled header='Lista'>
                                ...
                                <div className='p-grid' style={{ marginTop: 5, flexDirection: 'row' }}>
                                    ...
                                    <div className='p-col-12 p-md-6'>
                                        <label htmlFor='in' style={{ fontWeight: 'bold' }}>Carteira</label>
                                        <Dropdown
                                            filter={true}
                                            showClear={true}
                                            value={carteira}
                                            options={carteiras}
                                            filterBy='label,value'
                                            onChange={(e) => setCarteira(e.value)}
                                        />
                                    </div>
                                        ...
                                        <div className='p-grid'>
                                            ...
                                            <div className='p-col-12 p-md-12'>
                                                ...
                                                <Dropdown
                                                    ...
                                                    options={carteiras}
                                                    filterBy='label,value'
                                                    value={grupo.carteira?.id}
                                                    disabled={grupo.id ? true : false}
                                                    onChange={(e) => setGrupo({ ...grupo, carteira: { id: e.value } })}
                                                />
                                            </div>
                                            <div className='p-col-12 p-md-12'>
                                                <label htmlFor='in' style={{ fontWeight: 'bold' }}>Descrição *</label>
                                                <InputText
                                                    ...
                                                    onChange={(e) => setGrupo({ ...grupo, descricao: e.target.value })}
                                                />
                                            </div>
                                            <div className='p-col-12 p-md-12'>
                                                <Toolbar>
...
export default withRouter(GrupoReceitaDespesa);